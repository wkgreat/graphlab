...
interface RenderPassInfo {
    label: string
    first: boolean
    colorTexture: GPUTexture | GPUTextureView
    depthTexture: GPUTexture | GPUTextureView
    clearColor: GPUColor
    clearDepth: number
}

export function createRenderPassDescriptor(info: RenderPassInfo): GPURenderPassDescriptor {
        ...
        colorAttachments: [
            {
                ...
                loadOp: loadOp,
                storeOp: 'store',
                view: info.colorTexture
            }
        ],
        depthStencilAttachment: {
            view: info.depthTexture,
