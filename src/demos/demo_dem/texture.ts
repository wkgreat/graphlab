...
export async function createGeoTiffTexture(device: GPUDevice, tiff: GeoTIFFImage): Promise<GPUTexture> {
    ...
    device.queue.writeTexture(
        { texture },
        data.buffer,
        { bytesPerRow: width * 4 }, // Float32 占 4 字节
        [width, height]
    );
