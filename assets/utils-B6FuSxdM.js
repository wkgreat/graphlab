...
}`;class W{#r;#n;#e;#i;#s;#t;#o;#a=[];constructor(e){this.#r=e.ka,this.#n=e.ambient,this.#e=e.kd,this.#i=e.diffuse,this.#s=e.ks,this.#t=e.specular,this.#o=e.phong}addCallback(e){this.#a.push(e)}invokeChange(){for(const e of this.#a)e(this)}set ka(e){this.#r=e,this.invokeChange()}set ambient(e){this.#n=e,this.invokeChange()}set kd(e){this.#e=e,this.invokeChange()}set diffuse(e){this.#i=e,this.invokeChange()}set ks(e){this.#s=e,this.invokeChange()}set specular(e){this.#t=e,this.invokeChange()}set phong(e){this.#o=e,this.invokeChange()}get ka(){return this.#r}get ambient(){return this.#n}get kd(){return this.#e}get diffuse(){return this.#i}get ks(){return this.#s}get specular(){return this.#t}get phong(){return this.#o}}const F={OPAQUE:0,MASK:1,BLEND:2};class o{options;static bindgroupLayout;bindgroup;uniform;static defaultTexture;static defaultSampler;constructor(e){this.options=e}static getBindGroupLayout(e){if(!o.bindgroupLayout){const t=GPUShaderStage.FRAGMENT,r={sampleType:"float",viewDimension:"2d",multisampled:!1},n={type:"filtering"},i=e.createBindGroupLayout({label:"PbrMaterial",entries:[{binding:0,visibility:t,buffer:{type:"uniform"}},{binding:1,visibility:t,texture:r},{binding:2,visibility:t,sampler:n},{binding:3,visibility:t,texture:r},{binding:4,visibility:t,sampler:n},{binding:5,visibility:t,texture:r},{binding:6,visibility:t,sampler:n},{binding:7,visibility:t,texture:r},{binding:8,visibility:t,sampler:n},{binding:9,visibility:t,texture:r},{binding:10,visibility:t,sampler:n}]});o.bindgroupLayout=i}return o.bindgroupLayout}getDefaultTexture(e){if(o.defaultTexture==null){const t=e.createTexture({label:"pbrMaterial default texture",size:[1,1,1],format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});e.queue.writeTexture({texture:t},new Uint8Array([0,0,0,0]),{bytesPerRow:4},{width:1,height:1}),o.defaultTexture=t}return o.defaultTexture}getDefaultSampler(e){if(o.defaultSampler==null){const t=e.createSampler({label:"pbrMaterial default sampler",minFilter:"linear",magFilter:"linear",mipmapFilter:"linear"});o.defaultSampler=t}return o.defaultSampler}getBindGroup(e){if(!this.bindgroup){const t=e.createBindGroup({label:"pbrMaterial",layout:o.getBindGroupLayout(e),entries:[{binding:0,resource:{buffer:this.getUniform(e)}},{binding:1,resource:this.options.baseColorTexture??this.getDefaultTexture(e)},{binding:2,resource:this.options.baseColorSampler??this.getDefaultSampler(e)},{binding:3,resource:this.options.metallicRoughnessTexture??this.getDefaultTexture(e)},{binding:4,resource:this.options.metallicRoughnessSampler??this.getDefaultSampler(e)},{binding:5,resource:this.options.normalTexture??this.getDefaultTexture(e)},{binding:6,resource:this.options.normalSampler??this.getDefaultSampler(e)},{binding:7,resource:this.options.emmissiveTexture??this.getDefaultTexture(e)},{binding:8,resource:this.options.emmissiveSampler??this.getDefaultSampler(e)},{binding:9,resource:this.options.occlusionTexture??this.getDefaultTexture(e)},{binding:10,resource:this.options.occlusionSampler??this.getDefaultSampler(e)}]});this.bindgroup=t}return this.bindgroup}getUniform(e){if(!this.uniform){const t=T(D),r=w(t.uniforms.pbrMaterial),n=e.createBuffer({label:"pbrMaterial",size:r.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),i={baseColorFactor:this.options.baseColorFactor,hasBaseColorTexture:this.options.baseColorTexture==null?0:1,metallicFactor:this.options.metallicFactor,roughnessFactor:this.options.roughnessFactor,hasMetallicRoughnessTexture:this.options.metallicRoughnessTexture==null?0:1,normalScale:this.options.normalScale,hasNormalTexture:this.options.normalTexture==null?0:1,emmissiveFactor:this.options.emmissiveFactor,hasEmmissiveTexture:this.options.emmissiveTexture==null?0:1,occlusionStrength:this.options.occlusionStrength,hasOcclusionTexture:this.options.occlusionTexture==null?0:1,alphaMode:F[this.options.alphaMode],alphaCutoff:this.options.alphaCutoff};console.log(i),r.set(i),e.queue.writeBuffer(n,0,r.arrayBuffer),this.uniform=n}return this.uniform}destroy(){this.options.externalTexture||(this.options.baseColorTexture!=null&&(this.options.baseColorTexture.destroy(),this.options.baseColorTexture=null),this.options.metallicRoughnessTexture!=null&&(this.options.metallicRoughnessTexture.destroy(),this.options.metallicRoughnessTexture=null),this.options.normalTexture!=null&&(this.options.normalTexture.destroy(),this.options.normalTexture=null),this.options.emmissiveTexture!=null&&(this.options.emmissiveTexture.destroy(),this.options.emmissiveTexture=null),this.options.occlusionTexture!=null&&(this.options.occlusionTexture.destroy(),this.options.occlusionTexture=null))}}class q{#r;#n;#e=null;constructor(e,t){this.#r=e,this.#n=t}set position(e){this.#r=e}set color(e){this.#n=e}get position(){return this.#r}get color(){return this.#n}set x(e){this.#r[0]=e}set y(e){this.#r[1]=e}set z(e){this.#r[2]=e}addHelper(e,t){this.#e||(this.#e=new j(e,this,t))}}class j{params={position:{x:0,y:0,z:0},color:{r:255,g:255,b:255,a:1}};pane;folder=null;light;bindx;bindy;bindz;bindcolor;constructor(e,t,r){this.pane=e,this.light=t,this.params={position:{x:this.light.position[0],y:this.light.position[1],z:this.light.position[2]},color:{r:this.light.color[0]*255,g:this.light.color[1]*255,b:this.light.color[2]*255,a:this.light.color[3]*255}};let n=this.pane;r&&r.create&&(this.folder=e.addFolder({title:r.title,expanded:r.expanded}),n=this.folder),this.bindx=n.addBinding(this.params.position,"x",{label:"position x",min:-500,max:500,step:1}).on("change",i=>{this.light.x=i.value}),this.bindy=n.addBinding(this.params.position,"y",{label:"position y",min:-500,max:500,step:1}).on("change",i=>{this.light.y=i.value}),this.bindz=n.addBinding(this.params.position,"z",{label:"position z",min:-500,max:500,step:1}).on("change",i=>{this.light.z=i.value}),this.bindcolor=n.addBinding(this.params,"color",{label:"color"}).on("change",i=>{const l=[i.value.r/255,i.value.g/255,i.value.b/255,i.value.a];this.light.color=l})}}var I=`override MAX_LIGHTS: u32 = 10u;
...
}`;class k{#r;#n;#e;#i;#s;#t={};constructor(e){this.#r=e.label??"SimpleLine",this.#n=e.topology,this.#e=e.positions,this.#i=e.colors,this.#s=e.indices}get topology(){return this.#n}get positions(){return this.positions}get colors(){return this.#i}initWebGPU(e,t,r){this.#t.gpuinfo=e,this.#t.canvasinfo=t,this.#t.scene=r,this.refreshUniforms(),this.refreshVertexBuffers(),this.createPileline()}createDefaultColors(){const e=this.positions.length/3,t=[0,1,0,1];this.#i=new Float32Array(Array(e).fill(t).flat())}refreshVertexBuffers(e=!1){if(!this.#t.gpuinfo)return;const t=this.#t.gpuinfo.device;if(e||!this.#t.buffer){this.colors||this.createDefaultColors();const r=this.#t.buffer;if(this.#s){const n=v(t,{position:{data:this.#e,numComponents:3},colors:{data:this.#i,numComponents:4},indices:this.#s});this.#t.buffer=n}else{const n=v(t,{position:{data:this.#e,numComponents:3},colors:{data:this.#i,numComponents:4}});this.#t.buffer=n}r&&(r.buffers.forEach(n=>n.destroy()),r.indexBuffer&&r.indexBuffer.destroy())}}refreshUniforms(){this.#t.scene.refreshUniform()}createPileline(){const e=this.#t.gpuinfo.device;this.#t.module=e.createShaderModule({label:this.#r,code:I});const t=e.createPipelineLayout({bindGroupLayouts:[this.#t.scene.bindGroupLayout]}),r={label:this.#r,layout:t,vertex:{module:this.#t.module,buffers:this.#t.buffer.bufferLayouts},fragment:{module:this.#t.module,targets:[{format:this.#t.canvasinfo.context.getConfiguration().format}]},primitive:{topology:this.#n},depthStencil:{format:"depth32float",depthWriteEnabled:!0,depthCompare:"less-equal"}};this.#t.pipeline=e.createRenderPipeline(r)}draw(e){this.refreshUniforms(),this.refreshVertexBuffers();const t=this.#t.scene,r=this.#t.buffer;e.setPipeline(this.#t.pipeline),e.setBindGroup(0,t.bindGroup),e.setVertexBuffer(0,r.buffers[0]),this.#s?(e.setIndexBuffer(r.indexBuffer,r.indexFormat),e.drawIndexed(r.numElements)):e.draw(this.#e.length/3)}destroy(){for(const e of this.#t.buffer.buffers)e.destroy()}}class X{#r;#n;#e;#i;#s;#t;#o;constructor(e){this.#r=e.xlim??[0,1],this.#n=e.ylim??[0,1],this.#e=e.zlim??[0,1],this.#i=e.xcolor??[1,0,0,1],this.#s=e.ycolor??[0,1,0,1],this.#t=e.zcolor??[0,0,1,1],this.#o=new k({topology:"line-list",positions:new Float32Array([this.#r[0],0,0,this.#r[1],0,0,0,this.#n[0],0,0,this.#n[1],0,0,0,this.#e[0],0,0,this.#e[1]]),colors:new Float32Array([...this.#i,...this.#i,...this.#s,...this.#s,...this.#t,...this.#t]),indices:null})}initWebGPU(e,t,r){this.#o.initWebGPU(e,t,r)}draw(e){this.#o.draw(e)}}var A=`override MAX_LIGHTS: u32 = 10u;
...
@group(0) @binding(0) var<uniform> scene : SceneUniform;`;function m(s){return g(s[0],s[1],s[2])}function $(s){const e=a();return c(e,s),_(e,e),e}class K{camera;projection;#r=0;#n=0;lights=[];MAX_NUM_LIGHTS=16;#e={};constructor(e,t){this.camera=e,this.projection=t}addLight(e){this.lights.push(e)}refreshViewport(e,t){this.#r=e,this.#n=t}get viewportMatrix(){const r=this.#r/2,n=this.#n/2;return P(r,0,0,0,0,n,0,0,0,0,1,0,0+r,0+n,0,1)}get viewportMatrixInv(){return c(a(),this.viewportMatrix)}getRayOfPixel(e,t){t=this.#n-t;const r=this.viewportMatrix,n=this.projection.perspectiveMatrixZO,i=this.camera.viewMtx,l=L(a(),n,i),h=c(a(),l),f=c(a(),r),u=O(e,t,0,1),S=x(b(),u,f),p=x(b(),S,h),C=g(p[0],p[1],p[2]),d=g(this.camera.from[0],this.camera.from[1],this.camera.from[2]),B=U(y(),R(y(),C,d));return new M(d,B)}initWebGPU(e,t){this.#e.gpuinfo=e,this.#e.canvasinfo=t}refreshUniform(){if(this.#e.gpuinfo){const e=this.#e.gpuinfo.device;this.#e.definition||(this.#e.definition=T(A));const t=w(this.#e.definition.uniforms.scene);this.#e.uniform||(this.#e.uniform=e.createBuffer({label:"scene",size:t.arrayBuffer.byteLength,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}));const r={eye:m(this.camera.from),center:m(this.camera.to),up:m(this.camera.up),viewmtx:this.camera.viewMtx,viewmtxInv:c(a(),this.camera.viewMtx)},n={near:this.projection.near,far:this.projection.far,fovy:this.projection.fovy,aspect:this.projection.aspect,projmtx:this.projection.perspectiveMatrixZO,projmtxInv:c(a(),this.projection.perspectiveMatrixZO)},i={width:this.#r,height:this.#n,viewportmtx:this.viewportMatrix,viewportmtxInv:this.viewportMatrixInv},l=Math.min(this.MAX_NUM_LIGHTS,this.lights.length),h=[];for(let u=0;u<l;++u)h.push({position:this.lights[u].position,color:this.lights[u].color});const f={camera:r,projection:n,viewport:i,numLights:l,lights:h};t.set(f),e.queue.writeBuffer(this.#e.uniform,0,t.arrayBuffer)}}get bindGroupLayout(){if(this.#e.gpuinfo){const e=this.#e.gpuinfo.device;return this.#e.layout||(this.#e.layout=e.createBindGroupLayout({label:"scene",entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]})),this.#e.layout}return null}get bindGroup(){if(this.#e.gpuinfo){if(!this.#e.bindgroup){const e=this.#e.gpuinfo.device;this.#e.bindgroup=e.createBindGroup({layout:this.bindGroupLayout,entries:[{binding:0,resource:{buffer:this.#e.uniform}}]})}return this.#e.bindgroup}return null}get uniform(){return this.#e.uniform}}function Y(s){return Object.keys(s).length}function Z(s,e,t){return Math.min(Math.max(s,e),t)}function Q(s,e="Value must not be null or undefined"){if(s==null)throw new Error(e)}export{X as A,W as B,o as P,H as R,K as S,Q as a,q as b,G as c,Z as d,k as e,$ as n,Y as o,m as v};
