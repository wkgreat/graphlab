import{m as M,d as D,b as G,I as E,c as g,J as N,z as F,e as w,n as S,s as W,g as t,k as I,i as n,j as s}from"./camera-DTaZgdG7.js";import{N as A}from"./webgpuUtils-BvVMHRh1.js";import{C as l}from"./color-DsrcJaFb.js";const O=`\r
...
fn fs(input: VSOutput) -> @location(0) vec4f {\r
    return input.color;\r
        ...
        `,a="Frustum";this.shaderDefinition=M(o),this.refreshVertexBuffer(r),this.refreshUniform(r,u,i),this.module=r.createShaderModule({label:a,code:o}),this.pipeline=r.createRenderPipeline({label:a,layout:"auto",vertex:{module:this.module,buffers:this.vertexBuffer.bufferLayouts},fragment:{module:this.module,targets:[{format:e.canvas.context.getConfiguration().format,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha",operation:"add"}},writeMask:GPUColorWrite.ALL}]},primitive:{topology:"triangle-list",cullMode:"none",frontFace:"ccw"},depthStencil:{format:"depth32float",depthWriteEnabled:!1,depthCompare:"less"}})}draw(e,u,i,r){const o=e.device;this.refreshVertexBuffer(o),this.refreshUniform(o,u,i);const a=o.createBindGroup({label:"Frustum",layout:this.pipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.frustumUniform}},{binding:1,resource:{buffer:this.sceneUniform}}]});r.setPipeline(this.pipeline),r.setBindGroup(0,a),r.setVertexBuffer(0,this.vertexBuffer.buffers[0]),r.draw(this.#f.vertexCount)}}export{_ as F,Y as S};
